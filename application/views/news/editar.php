        ...
        <div class="col-lg-12 form-horizontal">
            <div class="row">
                <div class="col-lg-12 col-xs-12">
                    <form role="form" method="POST" action="<?php echo site_url($this->router->class . '/DB?acao=atualizar&cd=' . $objeto->ID);?>" enctype="multipart/form-data">

                        <div class="form-group">
                            <label class="col-lg-1 col-xs-1 control-label">Texto</label>
                            <div class="col-lg-11 col-xs-11">
                                <textarea class="form-control input-sm maiusculo large-editor  classic-editor" id="editor" style="resize: none" name="texto"><?php echo $objeto->texto;?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-11 col-xs-11">
                                <input type="checkbox" class="checkbox-medio" tabindex="1" name="visivel" <?php if ($objeto->visivel == 1) echo "checked";?>>
